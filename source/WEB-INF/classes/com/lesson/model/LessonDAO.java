...
public class LessonDAO implements LessonDAO_interface {
	...
	private static final String GET_history_ALL_STMT = "SELECT * FROM lesson where lesson_end_date<sysdate order by lesson_end_date";
	...
	private static final String GET_ALL_STMT = "SELECT * FROM lesson where lesson_end_date>=sysdate and lesson_status=1 order by lesson_no";
		...
		public List<LessonVO> getAllForAndroid() {
			...
			try {
				...
				while (rs.next()) {
					...
					lesson.setLessonName(rs.getString("lesson_name"));
					lesson.setLessonPrice(rs.getInt("lesson_price"));
					lesson.setLessonStartDate(rs.getDate("lesson_start_date"));
					lesson.setLessonEndDate(rs.getDate("lesson_end_date"));
					lesson.setLessonRegistration(rs.getInt("lesson_registration"));
					lesson.setLessonMaximumPeople(rs.getInt("lesson_maximum_people"));
					lesson.setLessonLocation(rs.getString("lesson_location"));
