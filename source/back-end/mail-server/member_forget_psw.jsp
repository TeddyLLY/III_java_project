	...
	<div class="container ">
		...
		<div class="row">
			<form method="post"
				...
				<h2 style="color: #283747;">請輸入會員帳戶資料</h2>
				<br>
				<br>
				<h3>請輸入 Email</h3>
				<div class="form-group">
					<label for="exampleInputEmail1">Email address</label> <input
						type="email" class="form-control" id="exampleInputEmail1" name="member_account"
						aria-describedby="emailHelp" placeholder="Enter email"> <small
						id="emailHelp" class="form-text text-muted">請輸入您註冊的Email <br>我們將傳送新密碼至您的信箱
					</small>
				</div>
				<div>
					<input type="hidden" name="action" value = "MemberNewPsw">
						<input type="button" onclick="location.href='<%=request.getContextPath() %>/front-end/gym_index/index.jsp'" class="btn btn-outline-info btn-lg" value="取消">
						<input type="submit" class="btn btn-info btn-lg" value= "確認" id="subit">
				</div>
			</form>
		</div>
	</div>
