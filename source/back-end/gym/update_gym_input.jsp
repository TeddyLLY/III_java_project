  ...
  <section id="container">
	...
	<%-- 錯誤表列 --%>
               ...
               <table
				...
				<td>健身房編號:<font color=red><b>*</b></font></td>
				<td><%=gymVO.getGym_no()%></td>
			</tr>
			<tr>
				<td>健身房名稱:</td>
				<td><input type="TEXT" name="gym_name" size="45"
					value="<%=gymVO.getGym_name()%>" /></td>
			</tr>

			<tr>
				<td>緯度:</td>
				<td><input type="TEXT" name="gym_latitude" size="45" 
				value="<%=gymVO.getGym_latitude()%>" /></td>

			</tr>
			<tr>
				<td>經度:</td>
				<td><input type="TEXT" name="gym_longitude" size="45" 
				value="<%=gymVO.getGym_longitude()%>" /></td>

			</tr>
			<tr>
				<td>地址:</td>
				<td><input type="TEXT" name="gym_address" size="45" 
				value="<%=gymVO.getGym_address()%>" /></td>

			</tr>
			<tr>
				<td>開館時間:</td>
				<td><input type="TEXT" name="gym_content" size="45"
					value="<%=gymVO.getGym_content()%>" /></td>
    		 ...
    		 <tr>
				...
				<td><input type="hidden" name="action" value="update"> 
      	  			<input type="hidden" name="gym_no" value="<%=gymVO.getGym_no()%>"> 
