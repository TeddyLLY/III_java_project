...
public class AppointmentOrderDetailDAO implements AppointmentOrderDetailDAO_interface {
	...
	private static final String GET_ONE_ALL_STMT = "SELECT appointment_order_detail_no,appointment_order_no,student_status,appointment_date"
			+ " FROM appointment_order_detail where appointment_order_no = ? order by appointment_date";
