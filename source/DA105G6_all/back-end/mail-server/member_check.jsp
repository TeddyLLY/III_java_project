		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="alert alert-success" role="alert">
					...
					<p>
						親愛的會員您好:註冊信箱信件:請點擊按鈕按鈕已獲得驗證信<br> 請至您註冊的信箱內收取驗證信,並且填寫驗證碼<br>
						...
						<form method="post"
							...
							<div class="form-group">
								<small id="Help" class="form-text text-muted">
									...
									name="member_passRandom" placeholder="ex : 857102">

							</div>
							<a
								href="<%=request.getContextPath()%>/front-end/gym_index/index.jsp"
								class="btn btn-outline-success">取消</a> <input type="hidden"
								name="action" value="member_passRandom"> <input
								type="submit" class="btn btn-info" value="確認">
						</form>
					</div>
				</div>
