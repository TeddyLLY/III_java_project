      	 ...
      	 for (int index = 0; index < buylist.size(); index++) {
			 ProductOrderDetailVO order = buylist.get(index);
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="order_recipient" name="order_recipient" value="" required/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12"><strong>地址:</strong></div>
                                <div class="col-md-12"><input type="order_address" name="order_address" class="order_address" value="" required/></div>
                            </div>
                        </div>
                    <!--SHIPPING METHOD END-->
                    <!--CREDIT CART PAYMENT-->
               ...
               <div class="form-group">
                   ...
                   <div class="col-md-12"><input placeholder="信用卡卡號" type="tel" name="number" required class="form-control"></div>
                   
                   <div class="col-md-12"><strong>持卡人:</strong></div>
                   <div class="col-md-12"><input placeholder="持卡人" type="text" name="name" required class="form-control"></div>
                   
                   <div class="col-md-12"><strong>卡片有效期限MM/YY:</strong></div>
                   <div class="col-md-12"><input placeholder="卡片有效期限MM/YY" type="tel" name="expiry" required class="form-control"></div>
                   
                   <div class="col-md-12"><strong>背面末3碼:</strong></div>
                   <div class="col-md-12"><input placeholder="背面末3碼" type="number" name="cvc" required class="form-control"></div>
                   </div>
               </div>
           </div>
                    </div>
