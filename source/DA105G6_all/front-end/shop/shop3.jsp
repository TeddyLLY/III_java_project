...
<body onload="connect();" onunload="disconnect();" class="body-wrapper">
<!-- header -->
<%
								...
								<div class="view">
									...
									<ul class="list-inline view-switcher">
										<li class="list-inline-item"><a
											href="<%=request.getContextPath()%>/front-end/shop/cart.jsp"><i class="shopping-cart text-right"></i></a>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="col-sm-12 col-lg-4 col-md-6">
								...
								<div class="product-item bg-light">
									<div class="card">
										...
										<div class="card-body">
				            <FORM id="form1" METHOD="post"	ACTION="<%=request.getContextPath()%>/product/product.do">
