...
<%
	...
	List<LessonVO> list0 = lessonSvc.getAll();
	pageContext.setAttribute("list0", list0);
%>
<%	MemberVO memVO = (MemberVO)session.getAttribute("memberVO");
	FavoriteLessonService flSvc = new FavoriteLessonService();
	List<FavoriteLessonVO> list = flSvc.getMemberFavoriteLesson(memVO.getMember_no());
...
<%@ include file="left_bar.file" %>
				...
				<div class="col-md-9">
					...
					<div class="product-grid-list">
						<div class="row mt-30">				 
							<c:forEach var="lessonVO" items="${list0}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
						<c:forEach var="flVO" items="${list}">
								...
								<div class="product-item bg-light">
									<div class="card">
										...
										<div class="card-body">
											...
											<a id="heart${lessonVO.lessonNo}" class="fa fa-heart fa-lg hvr-icon" onClick="favorite('${lessonVO.lessonNo}')"></a>
											<button id="btn${lessonVO.lessonNo}" type="button" class="btn btn-light pull-right" onClick="joinLesson('${lessonVO.lessonNo}','${lessonVO.lessonPrice}','${lessonVO.lessonRegistration+1}','${lessonVO.lessonMaximumPeople}')">$${lessonVO.lessonPrice}</button>
