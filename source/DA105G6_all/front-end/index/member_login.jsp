...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<%=request.getContextPath()%>/front-end/index/in/images/bg-01.jpg');">
			...
			<form class="login100-form validate-form" action="<%=request.getContextPath()%>/member.do"
				 ...
				 <div class="col-md-7 content_left_text">
				   <h3>Workout Anywhere</h3>
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						 ...
						 placeholder=" email" name="member_account" value="">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Enter password">
							<input type="password" class="input100"
							 id="member_psw" aria-describedby="Enter name" placeholder="passward" name="member_password" value="">
							<span class="focus-input100" data-placeholder="&#xf191;"></span>
					</div>

					<div class="container-login100-form-btn">
						 <input type="hidden" name="action" value="findOneMemberAccount">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="<%= request.getContextPath()%>/back-end/mail-server/member_forget_psw.jsp">
							忘記密碼?
						</a>
					</div>
				</form>
...
<script>
	$(".magic").click(function(){
    	$("#member_psw").val('123');
    	$("#member_email").val('yangood@gmail.com');
    })
</script>	
