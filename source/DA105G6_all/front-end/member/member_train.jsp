...
<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/css/muscle_group.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/css/col.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/js/col.js">
<meta charset="utf-8">
<title>會員訓練</title>
</head>
...
<br><br>
				<div class="conta" style="margin-left: 50px; padding: 0px;">
						<div class="content-column">
								<div class="nav">
									<div class="content">
										<p>
											hi <span class="name">${memberVO.member_name }</span>
										</p>
										<span class="shape score" style="font-size: 3em;">muscle</span><span
											class="shape" style="font-size: 3em;"> group</span>
									</div>
								</div>

							<div class="split-conta">
								<div class="split">
									<h3>訓練部位</h3>
									<div class="temperature" id="myMuscles0">無</div>
								</div>
								...
								<div class="split">
									<h3>組數</h3>
									<div class="calories" id="time">0</div>
								</div>
						</div>
							<div class="float-none">
								<div class="muscle-groups">
									<h2 style="color: #055A1B;">Arms</h2>
									<input type="checkbox" class="biceps muscles-helper" id="biceps">
									 <label for="biceps" style="white-space: nowrap;">二頭肌群</label> 
									 <input	type="checkbox" class="deltoids muscles-helper" id="deltoids">
									<label for="deltoids" style="white-space: nowrap;">三角肌群</label>
									<input type="checkbox" class="forearms muscles-helper"
										id="forearms"> <label for="forearms"
										style="white-space: nowrap;">前臂肌群</label> <input
										type="checkbox" class="triceps muscles-helper" id="triceps">
									<label for="triceps" style="white-space: nowrap;">三頭肌群</label>
									<h2 style="color: #055A1B;">Back</h2>
									<input type="checkbox" class="trapezius muscles-helper"
										id="trapezius"> <label for="trapezius"
										style="white-space: nowrap;">斜方肌群</label> <input
										type="checkbox" class="lats muscles-helper" id="lats">
									<label for="lats" style="white-space: nowrap;">背闊肌群</label>
									<h2 style="color: #055A1B;">Core</h2>
									<input type="checkbox" class="abs muscles-helper" id="abs">
									<label for="abs" style="white-space: nowrap;">腹肌群</label> <input
										type="checkbox" class="obliques muscles-helper" id="obliques">
									<label for="obliques" style="white-space: nowrap;">腹內斜肌群</label>
									<input type="checkbox" class="pectorals muscles-helper"
										id="pectorals"> <label for="pectorals"
										style="white-space: nowrap;">胸肌群</label>
									<h2 style="color: #055A1B;">Legs</h2>
									<input type="checkbox" class="adductors muscles-helper"
										id="adductors"> <label for="adductors"
										style="white-space: nowrap;">內收肌群</label> <input
										type="checkbox" class="calves muscles-helper" id="calves">
									<label for="calves" style="white-space: nowrap;">小腿後肌群</label>
									<input type="checkbox" class="hamstrings muscles-helper"
										id="hamstrings"> <label for="hamstrings"
										style="white-space: nowrap;">腿後側肌群</label> <input
										type="checkbox" class="glutes muscles-helper" id="glutes">
									<label for="glutes" style="white-space: nowrap;">臀大肌群</label> <input
										type="checkbox" class="quads muscles-helper" id="quads">
									<label for="quads" style="white-space: nowrap;">股四頭肌群</label>

									<svg width="100%" height="100%"
										style="margin-bottom: 10px; width: 80%; height: 80%;"
										viewBox="0 0 176 207" version="1.1"
										xmlns="http://www.w3.org/2000/svg"
										xmlns:xlink="http://www.w3.org/1999/xlink"
										xml:space="preserve"
										style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
										<rect id="Artboard1" x="0" y="0" width="175.551"
											height="206.785" style="fill:none;" />
										<g id="Back-Muscles">
										<g>
										<g id="Trapezius">
										<g>
...
var MyPoint = "/SynchronizeMotionWS/M001";
    ...
    //var endPointURL = "ws://192.168.196.33:8081/DA105G6/SynchronizeMotionWS/M001";
...
// 			  webSocket.send("My name is John");
		...
		webSocket.onmessage = function(event) {
	        ...
	        var count = document.getElementById('time').innerText = jsonObj.myMotions;
	        var myMuscles0 = document.getElementById('myMuscles0').innerText = jsonObj.myMuscles0;
	        var cal = document.getElementById('calories').innerText = jsonObj.oneCalorie;
	        document.getElementById('calories').innerText = (count * cal).toFixed(1);	
	        SizeToLarge();
// 	        $("g#Biceps").prop("checked",true);
if (myMuscles0 =="二頭肌"){
	        $('#Biceps').children("path").css({ fill: "red" });
	        $('#biceps').children("path").css({ fill: "red" });
}else if(myMuscles0 =="腹肌"){
			 $('#Abs').children("path").css({ fill: "red" });
			 $('#abs').children("path").css({ fill: "red" });
}
		};
 ...
 var size = 100;
        ...
        function SizeToLarge(){
            ...
            if(size>250){
                ...
                $("#time").css("font-size",size+"%");
                $("#time").css("color","#f15454");
                $("#calories").css("font-size",size+"%");
                $("#calories").css("color","#f15454");
