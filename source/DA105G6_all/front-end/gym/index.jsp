	...
	<div class="header">
		<div class="slideshow">
			<div class="slideshow-slides">
				<a href="./" class="slide" id="slide-1"><img src="./images/banner11.jpg" alt="" ></a>
				<a href="./" class="slide" id="slide-2"><img src="./images/banner12.jpg" alt=""></a>
				<a href="./" class="slide" id="slide-3"><img src="./images/banner13.jpg" alt=""></a>
			</div>
	...
	<!-- start header_bottom -->
	  <div class="header-bottom">
		 <div class="container">
			...
			<div class="social">	
			   <ul>	
				  <li class="facebook"><a href="<%=request.getContextPath()%>/front-end/cart.jsp"><span> </span></a></li>
		 ...
		 <div class="h_menu4"><!-- start h_menu4 -->
		   <a class="toggleMenu" href="#">Menu</a>
			 <ul class="nav">
			   ...
			   <li><a href="trainers.html">健身教學</a></li>
			   <li><a href="classes.html">健身房地點</a>
			   	
			   </li>
			   <li><a href="blog.html">直播</a></li>
			   <li><a href="pricing.html">討論區</a></li>
	...
	<!-- end menu -->
	 ...
	 <div class="row about">
		<div class="col-md-8">
			...
			<div class="ca-container" id="ca-container"><div class="ca-nav"><span class="ca-nav-prev">Previous</span><span class="ca-nav-next">Next</span></div>
			  <div class="ca-wrapper" style="overflow: hidden;">
				   
				  
				  
				  <div class="ca-item ca-item-4" style="left: 0px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon4"> </div>
					   </div>
				  </div>
				  <div class="ca-item ca-item-5" style="left: 315px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon5"> </div>
					  </div>
				  </div>
				  <div class="ca-item ca-item-6" style="left: 630px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon6"> </div>
					  </div>
				  </div>
				  <div class="ca-item ca-item-7" style="left: 945px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon7"> </div>
					  </div>
				  </div>
				  <div class="ca-item ca-item-8" style="left: 1260px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon"> </div>
					  </div>
				  </div>
		  <div class="ca-item ca-item-1" style="left: 1575px; position: absolute;">
					 <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon1"> </div>
					  </div>
					</div><div class="ca-item ca-item-2" style="left: 1890px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
						  <div class="ca-icon2"> </div>
					  </div>
				  </div><div class="ca-item ca-item-3" style="left: 2205px; position: absolute;">
					  <div class="ca-item-main">
						  <div class="ca-icon"> </div>
